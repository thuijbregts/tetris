...
public class J_Tetrimino extends Tetrimino {
    ...
    public J_Tetrimino(GameController gameController) {
        super(gameController);
        Mino[] minos1 = new Mino[MINOS_PER_TETRIMINO];
        minos1[0] = new Mino(0, Matrix.COLS/2 - (int) Math.ceil(MAX_LENGTH/2));
        minos1[1] = new Mino(1, Matrix.COLS/2 - (int) Math.ceil(MAX_LENGTH/2));
        ...
        minos2[1] = new Mino(0, Matrix.COLS/2 - (int) Math.ceil(MAX_LENGTH/2) + 2);
        minos2[2] = new Mino(1, Matrix.COLS/2 - (int) Math.ceil(MAX_LENGTH/2) + 1);
        ...
        minos4[0] = new Mino(2, Matrix.COLS/2 - (int) Math.ceil(MAX_LENGTH/2));
        ...
        color = BitmapFactory.decodeResource(GameActivity.gameActivity.getResources(), R.drawable.mino_j);
        ghostColor = GameActivity.gameActivity.getResources().getDrawable(R.drawable.ghost_j);
    }
