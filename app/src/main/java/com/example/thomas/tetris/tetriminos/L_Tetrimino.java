...
public class L_Tetrimino extends Tetrimino {
    ...
    public L_Tetrimino(GameController gameController) {
        ...
        minos1[2] = new Mino(1, Matrix.COLS/2 - (int) Math.ceil(MAX_LENGTH/2) + 2);
        ...
        minos2[2] = new Mino(2, Matrix.COLS/2 - (int) Math.ceil(MAX_LENGTH/2) + 1);
        ...
        minos3[2] = new Mino(1, Matrix.COLS/2 - (int) Math.ceil(MAX_LENGTH/2) + 2);
        minos3[3] = new Mino(2, Matrix.COLS/2 - (int) Math.ceil(MAX_LENGTH/2));
        ...
        minos4[1] = new Mino(0, Matrix.COLS/2 - (int) Math.ceil(MAX_LENGTH/2) + 1);
        ...
        color = BitmapFactory.decodeResource(GameActivity.gameActivity.getResources(), R.drawable.mino_l);
        ghostColor = GameActivity.gameActivity.getResources().getDrawable(R.drawable.ghost_l);
    }
