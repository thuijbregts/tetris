...
public class S_Tetrimino extends Tetrimino {
    ...
    public S_Tetrimino(GameController gameController) {
        super(gameController);

        Mino[] minos1 = new Mino[MINOS_PER_TETRIMINO];
        minos1[0] = new Mino(1, Matrix.COLS/2 - (int) Math.ceil(MAX_LENGTH/2));
        minos1[1] = new Mino(1, Matrix.COLS/2 - (int) Math.ceil(MAX_LENGTH/2) + 1);
        minos1[2] = new Mino(0, Matrix.COLS/2 - (int) Math.ceil(MAX_LENGTH/2) + 1);
        minos1[3] = new Mino(0, Matrix.COLS/2 - (int) Math.ceil(MAX_LENGTH/2) + 2);

        State state1 = new State(minos1);
        currentState = state1;

        Mino[] minos2 = new Mino[MINOS_PER_TETRIMINO];
        minos2[0] = new Mino(0, Matrix.COLS/2 - (int) Math.ceil(MAX_LENGTH/2) + 1);
        ...
        minos2[3] = new Mino(2, Matrix.COLS/2 - (int) Math.ceil(MAX_LENGTH/2) + 2);
        ...
        minos3[0] = new Mino(2, Matrix.COLS/2 - (int) Math.ceil(MAX_LENGTH/2));
        minos3[1] = new Mino(2, Matrix.COLS/2 - (int) Math.ceil(MAX_LENGTH/2) + 1);
        minos3[2] = new Mino(1, Matrix.COLS/2 - (int) Math.ceil(MAX_LENGTH/2) + 1);
        minos3[3] = new Mino(1, Matrix.COLS/2 - (int) Math.ceil(MAX_LENGTH/2) + 2);
        ...
        minos4[0] = new Mino(0, Matrix.COLS/2 - (int) Math.ceil(MAX_LENGTH/2));
        ...
        minos4[3] = new Mino(2, Matrix.COLS/2 - (int) Math.ceil(MAX_LENGTH/2) + 1);
        ...
        color = BitmapFactory.decodeResource(GameActivity.gameActivity.getResources(), R.drawable.mino_s);
        ghostColor = GameActivity.gameActivity.getResources().getDrawable(R.drawable.ghost_s);
    }
