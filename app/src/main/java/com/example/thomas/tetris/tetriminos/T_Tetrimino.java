...
public class T_Tetrimino extends Tetrimino {
    ...
    public T_Tetrimino(GameController gameController) {
        super(gameController);
        Mino[] minos1 = new Mino[MINOS_PER_TETRIMINO];
        minos1[0] = new Mino(0, Matrix.COLS/2 - (int) Math.ceil(MAX_LENGTH/2) + 1);
        ...
        minos3[3] = new Mino(2, Matrix.COLS/2 - (int) Math.ceil(MAX_LENGTH/2) + 1);
        ...
        color = BitmapFactory.decodeResource(GameActivity.gameActivity.getResources(), R.drawable.mino_t);
        ghostColor = GameActivity.gameActivity.getResources().getDrawable(R.drawable.ghost_t);
    }
